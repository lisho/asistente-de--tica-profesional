// User provided image URL for Eulogio's avatar
export const EULOGIO_AVATAR_URL = '/eulogio.png';
export const PEPI_AVATAR_URL = '/pepi.png'; // New avatar for Pepi

export const GEMINI_MODEL_NAME = 'gemini-2.5-flash-preview-04-17';

export const EXAMPLE_PROMPTS = [
  "¿Cuáles son los principios básicos del Código Deontológico?",
  "¿Cómo debo actuar ante un dilema de confidencialidad?",
  "Explícame el concepto de 'activismo ético' en trabajo social.",
  "¿Qué dice el código sobre la relación con la persona usuaria?",
  "Necesito información sobre el secreto profesional y sus excepciones."
];
...
DOCUMENTO DE INFORMACIÓN: ÉTICA Y DEONTOLOGÍA EN
EL TRABAJO SOCIAL EN ESPAÑA

Asunto: Revisión de los principales temas e ideas sobre ética y deontología en el
Trabajo Social en España, basándose en fuentes clave, incluyendo el Código
Deontológico vigente y análisis bibliométricos.

Resumen Ejecutivo
Este documento presenta un análisis de la ética y la deontología en el ámbito del
Trabajo Social en España, basándose en las fuentes proporcionadas. La identidad
del Trabajo Social es fundamentalmente moral, y la producción científica en ética
ha jugado un papel crucial en su consolidación. El Código Deontológico vigente,
aprobado en 2012, sirve como marco normativo esencial, detallando los valores,
principios y deberes que guían la práctica profesional.
Se destacan los principios básicos de dignidad, libertad e igualdad, así como
principios generales derivados. La confidencialidad y el secreto profesional son
pilares fundamentales, aunque existen excepciones claramente definidas. Se
reconoce la existencia de dilemas éticos en la práctica diaria, siendo la autonomía de
la persona usuaria y la confidencialidad los más frecuentes según estudios empíricos.
A pesar del conocimiento del Código Deontológico, su uso práctico y autoridad son a
veces relativizados por los profesionales, lo que subraya la necesidad de formación
continua y un "activismo ético" para fortalecer la identidad moral de la profesión y
humanizar la intervención social.

Análisis Detallado
1. La Identidad Moral del Trabajo Social
Las fuentes enfatizan que la identidad del trabajo social es intrínsecamente moral. El
análisis bibliométrico de Idareta et al. (2020) destaca que:
"La identidad del trabajo social es eminentemente moral y en la
consolidación de la misma ha tenido mucho que ver la producción
científica en materia de ética publicada hasta la fecha."
Esto subraya la importancia histórica y continua de la ética en la configuración de la
profesión.

2. El Código Deontológico como Marco Normativo
El Código Deontológico del Trabajo Social en España, cuya versión actual fue
aprobada por el Consejo General del Trabajo Social en 2012, es el principal
documento que articula los principios éticos y deontológicos. Este código, según el
Preámbulo del Consejo General del Trabajo Social (2012):
"...es el conjunto de valores, principios y normas que han de guiar el
ejercicio profesional de los/las trabajadores/as sociales en el Estado
español" (Artículo 1).
Su objetivo es, entre otros, "ahondar en los principios éticos y deontológicos
profesionales atendiendo a las nuevas realidades sociales y a las normas que influyen
directamente en la actividad profesional". El Código no es solo una recomendación,
sino que establece "obligaciones de necesario cumplimiento por los/as
colegiados/as" según la potestad pública de los colegios profesionales ("Deontología
y Trabajo Social: 10 años del actual Código Deontológico de la Profesión").

3. Principios Fundamentales y Generales
El Código Deontológico se fundamenta en valores universales como "la dignidad
humana, la libertad y la igualdad tal y como se contemplan en la Declaración
Universal de los Derechos Humanos" (Artículo 7). De estos principios básicos derivan
una serie de principios generales que deben guiar la práctica profesional. Algunos
de los más destacados son:
• Respeto activo a la persona: La persona, grupo o comunidad son el centro de
toda intervención profesional (Artículo 7).
• Aceptación de la persona: Reconocer y aceptar a la persona con sus
singularidades y diferencias (Artículo 7).
• Ausencia de juicios de valor: No emitir juicios sobre la persona, sus recursos,
motivaciones y necesidades (Artículo 7).
• Individualización y Personalización: Adecuar la intervención a las
particularidades de cada individuo, reconociéndolos como sujetos activos con
derechos y deberes (Artículo 7).
• Promoción integral de la persona: Considerar a la persona de manera holística
y trabajar por su desarrollo desde sus capacidades potenciales (Artículo 7).
• Igualdad de oportunidades, derechos, equidad y participación: Fomentar
que cada persona tenga capacidad para una mayor calidad de vida (Artículo 7).
• Solidaridad y Justicia Social: Implicarse en la construcción de una sociedad inclusiva y oponerse a situaciones de exclusión o estigmatización (Artículo 7).
Dedicar el ejercicio profesional a ayudar a individuos, grupos y comunidades en
su desarrollo y a resolver conflictos (Artículo 7).
• Autonomía y Autodeterminación: Confianza en las capacidades de los
profesionales y respeto por la libertad de decisión de la persona usuaria (Artículo
7).
• Responsabilidad y Corresponsabilidad: Con la persona usuaria, otros
profesionales e instituciones (Artículo 7).
• Colaboración profesional: Trabajar de manera activa, constructiva y solidaria
con otros profesionales (Artículo 7).
• Integridad: No abusar de la confianza, reconocer límites
personales/profesionales y no obtener beneficios personales de la posición
(Artículo 7).
Además, el Código establece que los profesionales del Trabajo Social "toman
decisiones justificadas éticamente, en conformidad con la Declaración Internacional
de Principios Éticos de la FITS, los Criterios Éticas Internacionales para los
Trabajadores Sociales y cuanto se establece en el presente Código Deontológico"
(Artículo 10). La Declaración Global de los Principios Éticos del Trabajo Social
(IFSW) refuerza estos principios, incluyendo el respeto por la diversidad, la promoción
del acceso equitativo a recursos, el desafío a políticas injustas, la promoción del
derecho a la participación, el trato integral de las personas y la promoción de la paz y
la no violencia.

4. Confidencialidad y Secreto Profesional
Un aspecto crucial de la ética en el Trabajo Social es la confidencialidad y el secreto
profesional. El Código Deontológico establece en su Artículo 48 que:
"La confidencialidad constituye una obligación en la actuación del/la
trabajador/a social y un derecho de la persona usuaria, y abarca a todas
las informaciones que el/la profesional reciba en su intervención social por
cualquier medio."
El secreto profesional se extiende a toda información confidencial obtenida, siendo
esta aquella de carácter personal que la persona usuaria no desea que se revele
(Artículo 50). Están sujetos a este secreto no solo los trabajadores sociales, sino
también otros profesionales que trabajen en equipo con ellos, estudiantes en
prácticas y voluntarios (Artículo 49).
...
• De consentimiento: Obtener autorización de la persona usuaria, garantizando la
confidencialidad y explicando el derecho a aceptar, rechazar o o retirar el
consentimiento.
• De Cesión de información y advertencia de confidencialidad: Indicar por
escrito que la información es confidencial y solo para el fin solicitado, evitando
discusiones en espacios públicos.
• De limitación: Limitar la información compartida con otros profesionales a lo
estrictamente indispensable.
• De cumplimiento de la legislación de protección de datos: Cumplir la
normativa vigente.
• De Finalidad: La información se usará para el fin para el que se recabó, salvo
excepciones.
• De custodia y acceso responsable: Custodiar la documentación y restringir el
acceso al personal autorizado.
Existen supuestos de exención de la confidencialidad y del secreto profesional,
donde la prioridad es "la vida, seguridad e integridad física, psicológica y social
de la persona usuaria" (Artículo 54). Estos supuestos incluyen situaciones de riesgo
previsible e inminente para la persona usuaria, el trabajador social o terceros. Otros
casos son cuando la persona usuaria o su representante legal liberan por escrito del
secreto, por mandato legal o judicial, cuando el trabajador social es denunciado, o
cuando terceros pueden resultar afectados de forma injusta y grave (Artículo 54). En
caso de duda, se prioriza la protección de los derechos fundamentales, el principio de
seguridad y el principio de libertad de decisión (Artículo 55).

5. Dilemas Éticos en la Práctica y su Afrontamiento
La práctica diaria del Trabajo Social presenta diversos dilemas éticos. El estudio de
caso de Idareta y Iturralde (2018) sobre Trabajo Social Sanitario revela que los dilemas
éticos más habituales están relacionados con:
"...la autonomía de la persona usuaria (46,6%), seguidos de los dilemas
éticos sobre la confidencialidad (26,6%)".
Otros dilemas mencionados incluyen la revelación de datos, decir la verdad, facilitar
información y conflictos de interés.
Frente a estos dilemas, la mayoría de los profesionales en el estudio tienden a
consultar a sus colegas (86,6%). Si bien las profesionales conocen la existencia del código deontológico, reconocen que lo utilizan poco y, a veces, "se relativiza la
autoridad del código deontológico" (Idareta & Iturralde, 2018). Esto sugiere que, a
pesar de la existencia de un marco normativo, la aplicación práctica y la
internalización de sus principios pueden ser desafíos.

6. Importancia de la Deontología y el "Activismo Ético"
Las fuentes subrayan la importancia del Código Deontológico como herramienta para
guiar la práctica profesional. Según Crespo Valencia y Luis-Yagüe López
("Deontología y Trabajo Social: 10 años del actual Código Deontológico de la
Profesión"), el Código:
"...es una herramienta donde se recogen de forma explícita, 'los valores,
principios y normas que han de guiar el ejercicio profesional del conjunto
de profesionales del trabajo social'".
Su conocimiento y aplicación son fundamentales para una "buena praxis" y para
"mantener el prestigio de la profesión".
Frente a la posible relativización del Código y los desafíos éticos diarios, se propone
el concepto de "activismo ético". Idareta y Iturralde (2018) argumentan que:
"...el activismo ético es una pieza clave... ya que permite a las y los
profesionales recobrar el sentido humanizante del trabajo social para
ponerlo a disposición de las personas usuarias renovado y actualizado."
Esto implica integrar la reflexión ética y el comportamiento moral consensuado en
la intervención, reconociendo que el código ético dota de sentido al deontológico, y
este último se actualiza gracias a la reflexión ética. Alcanzar la "excelencia" en la
intervención social requiere tanto el cumplimiento de los "mínimos morales" del
Código Deontológico como el respeto por los "valores de máximos".

7. Funciones e Instrumentos del Trabajador Social
El Preámbulo del Código Deontológico (Consejo General del Trabajo Social, 2012)
detalla las diversas funciones del profesional del Trabajo Social, que incluyen:
• Información
• Investigación
• Prevención
• Asistencia
...
• Docencia
• Coordinación
Para llevar a cabo estas funciones, los profesionales cuentan con instrumentos
específicos como la Historia Social, la Ficha Social, el Informe Social, las Escalas
de valoración social y el Proyecto de intervención social.

Conclusiones Clave
• La ética y la deontología son componentes esenciales y fundacionales de la
identidad del Trabajo Social en España.
• El Código Deontológico de 2012 proporciona un marco normativo detallado de
valores, principios y deberes.
• Los principios básicos de dignidad, libertad e igualdad, y los generales
derivados, son fundamentales para guiar la actuación profesional.
• La confidencialidad y el secreto profesional son derechos de la persona
usuaria y obligaciones del profesional, con excepciones definidas principalmente
en casos de riesgo grave.
• Los dilemas éticos, especialmente en torno a la autonomía y la confidencialidad,
son comunes en la práctica diaria.
• Aunque el Código Deontológico es conocido, su aplicación práctica y su
autoridad pueden ser desafíos, lo que subraya la necesidad de formación
continua.
• El "activismo ético", integrando la reflexión ética y la aplicación del Código, es
crucial para fortalecer la identidad moral de la profesión y humanizar la
intervención social.

Recomendaciones
• Fomentar la formación continua en ética y deontología para los profesionales
del Trabajo Social, especialmente en el abordaje de dilemas éticos.
• Promover el uso y la comprensión profunda del Código Deontológico como
una herramienta viva y relevante para la práctica diaria.
• Impulsar espacios de reflexión y debate entre profesionales para compartir
experiencias y estrategias en la resolución de dilemas éticos.
...
Este documento de información proporciona una visión general de los principales
temas y conceptos relacionados con la ética y la deontología en el Trabajo Social en
España, basándose en las fuentes proporcionadas.
`;

export const CODIGO_DEONTOLOGICO_TEXT = `
...
de las personas para incrementar el bienestar. Mediante la utilización de teorías sobre comportamiento humano y los sistemas sociales, el trabajo social interviene en los puntos
...
dignidad humana, la libertad y la igualdad³ tal y como se contemplan en la Declaración Universal
de los Derechos Humanos“, las instituciones democráticas y el Estado de Derecho. En ellos se
...
Artículo 9.- Los/as profesionales del trabajo social ejercen su profesión desde el respeto de los
...
Artículo 10.- Los/as profesionales del trabajo social toman decisiones justificadas éticamente,
...
Código Deontológico.
Artículo 11.- Los/as profesionales del trabajo social actúan desde los principios de derecho a la
...
Artículo 12.- Los/as profesionales del trabajo social tienen la responsabilidad de ejercitar su
...
Artículo 13.- Los/as profesionales del trabajo social, desde el respeto a las diferencias,
...
Artículo 14.- Los/as profesionales del trabajo social trabajan en estrecha colaboración con la
...
Artículo 15.- Los/as profesionales del trabajo social, promoviendo el compromiso y la
...
procurando la continuity de la intervención.
Artículo 21.- Cuando la acción o actividad de la persona usuaria, de forma real o potencial,
presente un grave riesgo (previsible o inminente) para sí o para otros, se procederá profesionalmente, con el consentimiento del equipo en su caso, a solicitar a quien corresponda
...
Artículo 29.- El/la profesional del trabajo social evalúe con criterios objetivos y rigurosos y de
...
C. RELACIÓN CON LAS INSTITUCIONES
Artículo 34.- Los/as profesionales del trabajo social se han de implicar profesionalmente en los
...
Artículo 36.- El/la profesional del trabajo social ha de conocer la normativa, la organización y el
...
realizar en la institución u organismo en los que presta sus servicios, y establecer prioridades con criterios objetivos acordes con la misión de la entidad y en función de las necesidades
...
с. El alumnado de trabajo social en prácticas y el voluntariado que ocasionalmente
...
с. Principio de libertad de decisión.
